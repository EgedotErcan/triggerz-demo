...
def transcribe_file(job_name, file_uri, transcribe_client):
    ...
    while max_tries > 0:
        ...
        time.sleep(10)
## function for storing txt on local pc
...
## program main
def main(current_waw_job_name):

    file_uri = f's3://myexpertunity/q{str(current_waw_job_name)}.wav'
    transcribe_file(current_waw_job_name, file_uri, transcribe_client)


if __name__ == '__main__':
    ## for whole dataset usage
